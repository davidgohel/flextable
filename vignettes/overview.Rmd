...
*I hope to be able to remove that constraints later.*
...
**Note [pandoc](https://pandoc.org/installing.html) version 2.4 is 
required for flextable rendering in pptx with `rmarkdown` and version 2.0 
for flextable rendering in docx.**
