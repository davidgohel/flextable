...
Beeing able to render flextable as images is requiring package `webshot` to be available.
Run the following command to install it. You may have to install `phantomjs` first.
