...
\CommentTok{\# debugging, as it\textquotesingle{}s impossible to do it interactively with quarto}
...
\CommentTok{\# pandoc\_args \textless{}{-} knitr::opts\_knit$get("rmarkdown.pandoc.args")}
\CommentTok{\# saveRDS(pandoc\_args, "./rmarkdown\_pandoc\_args.rds")}
